...
{
	insertPre(otherTree, root);
}


template <class elemType>
void bSearchTreeType<elemType>::
           insertPost(bSearchTreeType<elemType>& otherTree, binaryTreeNode<elemType> *p)
{
    if (p != NULL)
    {
...
template <class elemType>
void bSearchTreeType<elemType>::
          insertPre(bSearchTreeType<elemType>& otherTree, binaryTreeNode<elemType> *p)
{
    if (p != NULL)
    {
        cout << p->info << " ";
