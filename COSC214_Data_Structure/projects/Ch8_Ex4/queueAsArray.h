...
{
	//add your code here
	//method one: use an additional queues
	//method two: without an additional queues
	//case 1: if front<=index of name
	//case 2: front<index of n, means index is ahead of front 
	//case 2 needs to consider how to move last element to the first  slot
}
