...
//This program uses the function setf to use the 
//manipulators fixed and showpoint. See statement 
//in Lines 9a and 9b. 
...
{                                                     //Line 6
    ...
    cout.setf(ios::fixed);                            //Line 9a
    cout.setf(ios::showpoint);                        //Line 9b
